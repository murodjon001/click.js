...
var MerchantApi = class {
   ...
   */
  get authorization() {
    const timestampHashAndSecretKeyHash = (0, import_sha1.default)(String(this.timestamp) + this.secret_key).toString();
...
var ShoppingApi = class {
  ...
  set signStringForPrepare(params) {
    ...
    this.sign_string = (0, import_md5.default)(data).toString();
  }
